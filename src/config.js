...
const config = {
    ...
    sumsub_app_token:process.env.VUE_APP_SUMSUB_APP_TOKEN,
    sumsub_secret_key:process.env.VUE_APP_SUMSUB_SECRET_KEY,
    sumsub_api_baseurl:process.env.VUE_APP_SUMSUB_BASE_URL,
    eventActionType: {
