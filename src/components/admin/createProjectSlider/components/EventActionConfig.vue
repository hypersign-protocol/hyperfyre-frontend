        ...
        >
          <span>
            ...
            <img
              ...
              v-if="eventAction.type.includes('_ETH')"
              height="22px"
            />
            <img
              style="padding-right: 5px"
              src="/img/ethereum.2b470564.svg"
              v-if="eventAction.type.includes('ETHEREUM')"
              height="22px"
            />
            <img
              style="padding-right: 5px"
              src="../../../../assets/matic-logo.svg"
              v-if="eventAction.type.includes('MATIC')"
              height="20px"
            />
            <img
              style="padding-right: 5px"
              src="../../../../assets/binance-logo.svg"
              v-if="eventAction.type.includes('BINANCE')"
              height="20px"
            />
            <img
              style="padding-right: 5px"
              src="../../../../assets/tezos.png"
              v-if="eventAction.type.includes('_TEZ')"
              height="22px"
            />
          </span>
    ...
    <div>
      ...
      <div class="row g-3 align-items-center w-100 mt-4" v-if="nodDisplay">
        ...
        <div class="col-lg-9 col-md-9 px-0">
          <input
            ...
            type="text"
            :placeholder="
              selected.type === null ? '' : 'Please Enter Your ' + [[CapitaliseString(selected.type)]] + ' ' + 'handle'
            "
            id="value"
            class="form-control w-100"
          />
          <span class="inputInfo" v-if="selected.type === 'TELEGRAM_JOIN'"
            >Make sure to add
            <a target="_blank" :href="`https://telegram.me/${hfTgBotId}?startgroup=any`">Hyperfyre Telegram Bot</a> in
            your public group, for this functionality to work properly.</span
          >
        </div>
      </div>
      ...
      <div class="row g-3 justify-content-md-end w-100 mt-4" v-if="isCreate == true">
        <div class="col-lg-6 col-md-9 px-0">
          <button @click="handleEventActionAdd()" class="btn button-theme" type="button">
      ...
      <div class="row g-3 justify-content-md-end w-100 mt-4" v-else>
        <div class="col-lg-6 col-md-9 px-0">
          <button @click="handleEventActionUpdate()" class="btn button-theme slight-left-margin" type="button">
            Update
          </button>
...
export default {
  ...
  computed: {
    ...
    url() {
      if (this.eventActionType === 'CUSTOM' && this.selected.type === 'HYPERLINK_URL') return true;
    },
