    ...
    >
      <b-row>
        <b-col cols="1" sm="1" md="1">
          <img
            src="https://sumsub.com/wp-content/uploads/2019/02/SS-logo-big-floating-1024x747.png.pagespeed.ce.z-fgtDC2mQ.png"
            height="20px"
          />
        </b-col>
      ...
      try {
        if (this.kycData.reviewResult.reviewAnswer === "GREEN" && this.kycData.reviewStatus === "completed") {
          ...
          return this.notifyWarning(
            "Your Kyc verfication is not completed, You will be notified via mail after verification"
          );
        }
      } catch (e) {
        return this.notifyWarning(
