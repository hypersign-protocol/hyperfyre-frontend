  ...
  <div>
    <div v-if="isProjectEditing" class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Event Id"></tool-tips><label for="eventId" class="col-form-label"> </label>
    ...
    <div class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Name of the event"></tool-tips><label for="endDate" class="col-form-label"></label
    ...
    <div v-if="isProjectEditing" class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Slug of the event. It should be unique across the platform"></tool-tips
        ><label for="slug" class="col-form-label"> </label
        ><label for="slug" class="col-form-label">Event Slug<span style="color: red">*</span>: </label>
      </div>
      <div class="col-lg-9 col-md-9 px-0">
    ...
    <div v-if="isProjectEditing" class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Event status"></tool-tips
    ...
    <div class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Url of banner image"></tool-tips
    ...
    <div class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Start date time of the event"></tool-tips
      ...
      <div class="col-lg-9 col-md-9 px-0 datepicker">
        <datepicker v-model="project.fromDate" name="fromDate" format="YYYY-MM-DD h:i:s" />
      </div>
    </div>

    <div class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="End date time of the event"></tool-tips
        ><label for="endDate" class="col-form-label">End Date<span style="color: red">*</span>: </label>
      </div>
      <div class="col-lg-9 col-md-9 px-0">
        <Datepicker class="datepicker" v-model="project.toDate" name="toDate" format="YYYY-MM-DD h:i:s" />
      </div>
    </div>
    ...
    <div>
      <div class="row g-3 align-items-center w-100 mt-4">
        <div class="text-left col-lg-3 col-md-3 text-left">
          <tool-tips infoMessage="Select one or more tags"></tool-tips
        ...
        <div class="col-lg-1 col-md-1 px-0">
          <button
            ...
            class="btn button-theme slight-left-margin-5"
            :style="buttonThemeCss"
            type="button"
          >
            {{ eventActionList.includes(selected) ? "Cancel" : "Add" }}
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 align-items-center w-100 mt-4">
      <div class="col-lg-3 col-md-3 text-left">
        <tool-tips infoMessage="Notify participants about your upcoming campaign"></tool-tips
        ><label for="endDate" class="col-form-label">Notification: </label>
      </div>
      <div class="col-lg-9 col-md-9 px-0">
        <b-form-checkbox v-model="project.isNotificaionEnabled" name="check-button" switch> </b-form-checkbox>
      </div>
    </div>
  </div>
</template>
