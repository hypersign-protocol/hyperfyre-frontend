          ...
          <div class="card-body">
            <div class="row g-3 align-items-center w-100 mt-4">
              <div class="text-left col-lg-8 col-md-8 text-left">
                <tool-tips infoMessage="Enter color in HEX format"></tool-tips
                ><label for="name" class="col-form-label">Theme Color <span style="color: red">*</span>: </label>
              </div>
              <div class="col-lg-4 col-md-4 px-0">
                <input
                  type="color"
                  id="name"
                  v-model="orgSetting.themeColor"
            ...
            <div class="row g-3 align-items-center w-100 mt-4">
              <div class="text-left col-lg-8 col-md-8 text-left">
                <tool-tips infoMessage="Enter color in HEX format"></tool-tips
                ><label for="name" class="col-form-label">Button Color <span style="color: red">*</span>: </label>
              </div>
              <div class="col-lg-4 col-md-4 px-0">
                <input
                  type="color"
                  id="name"
                  v-model="orgSetting.buttonBGColor"
                  class="form-control w-100"
            ...
            <div class="row g-3 align-items-center w-100 mt-4">
              <div class="text-left col-lg-8 col-md-8 text-left">
                <tool-tips infoMessage="Enter color in HEX format"></tool-tips
                ><label for="name" class="col-form-label">Button Font Color <span style="color: red">*</span>: </label>
              </div>
              <div class="col-lg-4 col-md-4 px-0">
                <input
                  type="color"
                  id="name"
                  v-model="orgSetting.buttonTextColor"
                  class="form-control w-100"
            ...
            <div class="row g-3 align-items-center w-100 mt-4">
              <div class="text-left col-lg-8 col-md-8 text-left">
                <tool-tips infoMessage="Enter logo path"></tool-tips
                ><label for="name" class="col-form-label">Logo Path: </label>
              </div>
              <div class="col-lg-4 col-md-4 px-0">
                <input
                  type="text"
                  placeholder="https://app.fyre.hypersign.id/img/Fyre_Small.e094f135.png"
                  id="name"
                  v-model="orgSetting.logoPath"
                  class="form-control w-100"
                />
              </div>
            </div>
            <div class="row g-3 align-items-center w-100 mt-4" style="float: right; padding-right: 1.5%">
              <div class="text-left col-lg-6 col-md-6 text-right"></div>

              <div class="text-left col-lg-6 col-md-6 text-right">
                <button class="btn button-theme" :style="buttonThemeCss" type="submit" @click="update">Update</button>
              </div>
            </div>
          </div>
        </div>
