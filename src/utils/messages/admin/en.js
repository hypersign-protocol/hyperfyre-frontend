...
const EVENTS = {
  ...
  ACTIONS: {
    ...
    SCORE_IS_POSITIVE_NUM:
      "Please enter a Score that should be a Positive number",
    ...
    SMARTCONTRACT: {
      ...
      THBALANCE_NOT_NEGATIVE:
        "Enter the Threshold balance that should be a Positive Number",
...
const SUBSCRIPTIONS = {
  ...
  SUBSCRIPTION_EXHAUSTED:
    "Your Subscription has been exhauseted. Please subscribe to New Plan",
