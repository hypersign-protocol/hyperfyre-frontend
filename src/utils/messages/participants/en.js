...
const EVENT_ACTIONS = {
  ...
  TELEGRAM_JOIN: {
    ...
    FETCH_USERNAME_FAILED:
      "Could not fetch the username after telegram authentication",
    JOIN_TG: "Please Join and then try again",
    ASK_ADMIN_TO_SET_GROUPID:
      "Please ask organizer to set proper group username at the admin panel or make sure you added the bot to your channel or group",
  },
  DISCORD_JOIN: {
  ...
  TWITTER_FOLLOW: {
    ...
    TWITTER_SCREENS_BLANK:
      "Error: Source or target twitter screen name is  blank",
  },
  TWITTER_RETWEET: {
